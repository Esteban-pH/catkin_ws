...
class DialogflowServiceRequest {
  ...
  static datatype() {
    ...
    return 'dialogflow_ros/DialogflowServiceRequest';
  }
...
module.exports = {
  ...
  md5sum() { return '94d2cddd2d00600a6046c91cf0b001a9'; },
  datatype() { return 'dialogflow_ros/DialogflowService'; }
};
