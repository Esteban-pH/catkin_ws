...
(cl:in-package dialogflow_ros-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <DialogflowService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DialogflowService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dialogflow_ros-srv:<DialogflowService-request> is deprecated: use dialogflow_ros-srv:DialogflowService-request instead.")))

(cl:ensure-generic-function 'voice-val :lambda-list '(m))
(cl:defmethod voice-val ((m <DialogflowService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-srv:voice-val is deprecated.  Use dialogflow_ros-srv:voice instead.")
  (voice m))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <DialogflowService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-srv:text-val is deprecated.  Use dialogflow_ros-srv:text instead.")
  (text m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DialogflowService-request>)))
  ...
  "dialogflow_ros/DialogflowServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DialogflowService-request)))
  "Returns string type for a service object of type 'DialogflowService-request"
  "dialogflow_ros/DialogflowServiceRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DialogflowService-request>)))
  ...
  "94d2cddd2d00600a6046c91cf0b001a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DialogflowService-request)))
  "Returns md5sum for a message object of type 'DialogflowService-request"
  "94d2cddd2d00600a6046c91cf0b001a9")
...
(cl:defclass <DialogflowService-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (result
    :reader result
    :initarg :result
    :type dialogflow_ros-msg:DialogflowResult
    :initform (cl:make-instance 'dialogflow_ros-msg:DialogflowResult)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DialogflowService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DialogflowService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dialogflow_ros-srv:<DialogflowService-response> is deprecated: use dialogflow_ros-srv:DialogflowService-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <DialogflowService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-srv:success-val is deprecated.  Use dialogflow_ros-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <DialogflowService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-srv:result-val is deprecated.  Use dialogflow_ros-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DialogflowService-response>)))
  ...
  "dialogflow_ros/DialogflowServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DialogflowService-response)))
  "Returns string type for a service object of type 'DialogflowService-response"
  "dialogflow_ros/DialogflowServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DialogflowService-response>)))
  ...
  (cl:format cl:nil "bool success~%DialogflowResult result~%~%================================================================================~%MSG: dialogflow_ros/DialogflowResult~%string action~%string query_text~%string fulfillment_text~%DialogflowParameter[] parameters~%DialogflowContext[] contexts~%string intent~%================================================================================~%MSG: dialogflow_ros/DialogflowParameter~%string name~%string value~%================================================================================~%MSG: dialogflow_ros/DialogflowContext~%string name~%int32 lifespan_count~%DialogflowParameter[] parameters~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DialogflowService-response)))
  "Returns full string definition for message of type 'DialogflowService-response"
  (cl:format cl:nil "bool success~%DialogflowResult result~%~%================================================================================~%MSG: dialogflow_ros/DialogflowResult~%string action~%string query_text~%string fulfillment_text~%DialogflowParameter[] parameters~%DialogflowContext[] contexts~%string intent~%================================================================================~%MSG: dialogflow_ros/DialogflowParameter~%string name~%string value~%================================================================================~%MSG: dialogflow_ros/DialogflowContext~%string name~%int32 lifespan_count~%DialogflowParameter[] parameters~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DialogflowService)))
  ...
  "dialogflow_ros/DialogflowService")