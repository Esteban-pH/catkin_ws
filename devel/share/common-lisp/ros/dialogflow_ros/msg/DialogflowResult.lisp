...
(cl:defclass <DialogflowResult> (roslisp-msg-protocol:ros-message)
  ((action
   ...
   (parameters
    :reader parameters
    :initarg :parameters
    :type (cl:vector dialogflow_ros-msg:DialogflowParameter)
   :initform (cl:make-array 0 :element-type 'dialogflow_ros-msg:DialogflowParameter :initial-element (cl:make-instance 'dialogflow_ros-msg:DialogflowParameter)))
   (contexts
    :reader contexts
    :initarg :contexts
...
(cl:defmethod cl:initialize-instance :after ((m <DialogflowResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DialogflowResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dialogflow_ros-msg:<DialogflowResult> is deprecated: use dialogflow_ros-msg:DialogflowResult instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <DialogflowResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-msg:action-val is deprecated.  Use dialogflow_ros-msg:action instead.")
  (action m))
...
(cl:defmethod fulfillment_text-val ((m <DialogflowResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-msg:fulfillment_text-val is deprecated.  Use dialogflow_ros-msg:fulfillment_text instead.")
  (fulfillment_text m))

(cl:ensure-generic-function 'parameters-val :lambda-list '(m))
(cl:defmethod parameters-val ((m <DialogflowResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-msg:parameters-val is deprecated.  Use dialogflow_ros-msg:parameters instead.")
  (parameters m))
...
(cl:defmethod intent-val ((m <DialogflowResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dialogflow_ros-msg:intent-val is deprecated.  Use dialogflow_ros-msg:intent instead.")
  (intent m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DialogflowResult>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'parameters)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dialogflow_ros-msg:DialogflowParameter))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DialogflowResult>)))
  ...
  "dialogflow_ros/DialogflowResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DialogflowResult)))
  "Returns string type for a message object of type 'DialogflowResult"
  "dialogflow_ros/DialogflowResult")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DialogflowResult>)))
  ...
  "a4d94056b1f3887e01d5b858f7f1a2c4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DialogflowResult)))
  "Returns md5sum for a message object of type 'DialogflowResult"
  "a4d94056b1f3887e01d5b858f7f1a2c4")
